import type { ServerStatus } from "@openmushi/plugin-local-stt";
      ...
      toast: {
        ...
        description: (
          <>
            ...
            to make Open Mushi listen to your conversations.
          </>
        ),
        primaryAction: {
      ...
      toast: {
        ...
        description: (
          <>
            ...
            make Open Mushi summarize and chat about your conversations.
          </>
        ),
        primaryAction: {
