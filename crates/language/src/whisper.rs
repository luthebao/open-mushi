...
impl TryInto<openmushi_whisper::Language> for Language {
    type Error = Error;

    fn try_into(self) -> Result<openmushi_whisper::Language, Self::Error> {
        use openmushi_whisper::Language as WL;
...
impl TryInto<Language> for openmushi_whisper::Language {
    type Error = Error;
