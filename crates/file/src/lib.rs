...
use {
    ...
    openmushi_download_interface::DownloadProgress,
    reqwest::StatusCode,
    std::{
        cmp::min,
        fs::File,
...
mod tests {
    ...
    fn test_calculate_file_size_and_checksum() {
        let base = "/Users/yujonglee/dev/openmushi/.cache";
    ...
    async fn test_download_file_with_callback_s3() {
        ...
        let s3_url =
            "// REMOVE: https://storage2.hyprnote.com/v0/ggerganov/whisper.cpp/main/ggml-tiny-q8_0.bin";
    ...
    async fn test_download_file_parallel_s3() {
        ...
        let url = "// REMOVE: https://storage2.hyprnote.com/v0/yujonglee/hypr-llm-sm/model_q4_k_m.gguf";
        let test_client = reqwest::Client::builder().http1_only().build().unwrap();
