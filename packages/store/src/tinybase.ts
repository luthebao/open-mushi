...
export const tableSchemaForTinybase = {
  workspaces: {
    ...
    name: { type: "string" },
  } as const satisfies InferTinyBaseSchema<typeof workspaceSchema>,
  sessions: {
    user_id: { type: "string" },
    created_at: { type: "string" },
  ...
  } as const satisfies InferTinyBaseSchema<typeof extensionArtifactSchema>,
  chat_shortcuts: {
    user_id: { type: "string" },
    title: { type: "string" },
    content: { type: "string" },
