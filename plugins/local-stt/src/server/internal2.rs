...
use openmushi_cactus_model::CactusSttModel;
...
pub struct Internal2STTArgs {
    ...
    pub cactus_config: openmushi_transcribe_cactus::CactusConfig,
}
...
impl Actor for Internal2STTActor {
    ...
    async fn pre_start(
        ...
        let cactus_service = HandleError::new(
            openmushi_transcribe_cactus::TranscribeService::builder()
