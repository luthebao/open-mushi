...
pub fn import_audio(
    ...
    match rodio::Decoder::try_from(file) {
        ...
        Err(_original_err) => {
            #[cfg(target_os = "macos")]
            {
                let wav_path = openmushi_afconvert::to_wav(source_path)
...
mod tests {
    ...
    test_import_audio! {
        test_import_wav: openmushi_data::english_1::AUDIO_PATH,
        test_import_mp3: openmushi_data::english_1::AUDIO_MP3_PATH,
        test_import_mp4: openmushi_data::english_1::AUDIO_MP4_PATH,
        test_import_m4a: openmushi_data::english_1::AUDIO_M4A_PATH,
        test_import_ogg: openmushi_data::english_1::AUDIO_OGG_PATH,
        test_import_flac: openmushi_data::english_1::AUDIO_FLAC_PATH,
        test_import_aac: openmushi_data::english_1::AUDIO_AAC_PATH,
        test_import_aiff: openmushi_data::english_1::AUDIO_AIFF_PATH,
        test_import_caf: openmushi_data::english_1::AUDIO_CAF_PATH,
    }
}
